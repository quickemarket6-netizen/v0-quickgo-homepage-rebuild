...
export function WhatsAppButton({ 
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Panel */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-80 bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl animate-in slide-in-from-bottom-4 duration-300 overflow-hidden">
          {/* Glow effect */}
          <div className="absolute -inset-[1px] bg-gradient-to-r from-green-500/20 to-lime-500/20 rounded-2xl blur-sm -z-10" />
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-500 p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-white font-semibold">QuickGo Support</h4>
                  <p className="text-green-100 text-xs flex items-center gap-1">
                    <span className="w-2 h-2 bg-lime-300 rounded-full animate-pulse" />
                    En ligne - Reponse rapide
                  </p>
                </div>
              </div>
              <button 
          ...
          <div className="p-4 bg-gray-900">
            {/* Welcome Message */}
            <div className="bg-gray-800 rounded-2xl rounded-tl-none p-3 mb-4">
              <p className="text-gray-300 text-sm">
                Bonjour! Comment pouvons-nous vous aider aujourd&apos;hui? 
                Ecrivez votre message et nous vous repondrons rapidement sur WhatsApp.
              </p>
              <p className="text-gray-500 text-xs mt-2">QuickGo Support</p>
            </div>
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-xl p-3 pr-12 text-white placeholder-gray-500 text-sm resize-none focus:outline-none focus:border-green-500 transition-colors"
                rows={3}
              />
              <button
                onClick={handleSend}
                className="absolute bottom-3 right-3 p-2 bg-green-500 hover:bg-green-600 rounded-full transition-colors"
              >
