...
// Frontière d'erreur de l'espace vendeur (cf. app/admin/error.tsx).
      ...
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <div>
          <h1 className="text-xl font-bold text-foreground mb-2">
            Cette page vendeur a rencontré une erreur
          </h1>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/vendor/dashboard"><Button variant="outline">Tableau de bord</Button></Link>
        </div>
      </div>
    </div>
  )
