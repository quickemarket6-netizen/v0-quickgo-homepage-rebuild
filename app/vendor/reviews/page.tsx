  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[#eab308] blur-[130px] animate-orb"
          style={{ "--orb-s": "1.2", "--orb-o-min": "0.15", "--orb-o-max": "0.35", "--orb-dur": "9s" } as React.CSSProperties}
          />
        <div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-[#22c55e] blur-[120px] animate-orb"
          style={{ "--orb-s": "1.2", "--orb-o-min": "0.15", "--orb-o-max": "0.3", "--orb-dur": "11s", "--orb-delay": "3s" } as React.CSSProperties}
          />
        <div
          className="absolute top-2/3 left-1/2 w-72 h-72 rounded-full bg-[#8b5cf6] blur-[120px] animate-orb"
      ...
      <main className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        <div className="relative overflow-hidden bg-[#111118]">
          ...
          {/* Mini orbs in header */}
          <div
            className="absolute top-0 left-1/4 w-40 h-20 rounded-full bg-[#eab308] blur-3xl opacity-30 animate-orb"
            style={{ "--orb-s": "1.3", "--orb-o-min": "0.3", "--orb-o-max": "0.6", "--orb-dur": "6s" } as React.CSSProperties}
            />
          <div
            className="absolute top-0 right-1/3 w-32 h-16 rounded-full bg-[#22c55e] blur-3xl opacity-20 animate-orb"
