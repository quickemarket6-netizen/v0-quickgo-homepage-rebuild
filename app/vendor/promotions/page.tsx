    ...
    <div className="min-h-screen bg-[#0a0a0f] flex">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div
          ...
          />
        <div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-[#eab308] blur-[120px] animate-orb"
      ...
      <main className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        <div className="relative overflow-hidden bg-[#111118]">
          ...
          <div
            ...
            />
          <div
            className="absolute top-0 right-1/3 w-32 h-16 rounded-full bg-[#eab308] blur-3xl opacity-20 animate-orb"
