  ...
  return (
    <div className="h-screen bg-[#0a0a0f] flex overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full bg-[#8b5cf6] blur-[120px] animate-orb"
          style={{ "--orb-s": "1.2", "--orb-o-min": "0.15", "--orb-o-max": "0.35", "--orb-dur": "8s" } as React.CSSProperties} />
        <div className="absolute bottom-[-10%] right-[-5%] w-[600px] h-[600px] rounded-full bg-[#6366f1] blur-[120px] animate-orb"
          style={{ "--orb-s": "1.15", "--orb-o-min": "0.15", "--orb-o-max": "0.35", "--orb-dur": "10s", "--orb-delay": "3s" } as React.CSSProperties} />
        <div className="absolute top-[40%] left-[40%] w-[400px] h-[400px] rounded-full bg-[#a78bfa] blur-[120px] animate-orb"
          style={{ "--orb-s": "1.25", "--orb-o-min": "0.1", "--orb-o-max": "0.25", "--orb-dur": "12s", "--orb-delay": "6s" } as React.CSSProperties} />
      </div>
