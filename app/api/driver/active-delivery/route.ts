...
export async function GET() {
  ...
  if (activeOrder) {
    ...
    return NextResponse.json({
      ...
      destination: addr,
      dest_lat: activeOrder.delivery_latitude as number | null,
      dest_lng: activeOrder.delivery_longitude as number | null,
  ...
  if (activeRequest) {
    ...
    return NextResponse.json({
      ...
      dest_lat: activeRequest.dropoff_lat as number | null,
      dest_lng: activeRequest.dropoff_lng as number | null,
