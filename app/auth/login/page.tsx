...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-12" onClick={handleGoogleLogin} type="button">
      ...
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-primary/20 via-background to-secondary/20">
